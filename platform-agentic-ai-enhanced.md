...
> **Note:** Agent CLI for AKS works with AKS-MCP Server deployed either **locally** (on developer workstation) or **remotely** (in-cluster). See the [AKS MCP](#aks-mcp) section for detailed Local and Remote deployment diagrams and configuration options.
